...
import Tags from '@/layout/components/Tags/Tags.vue'
...
watch(() => settingsStore.menu.subMenuCollapse, val => {
    if (settingsStore.mode === 'mobile') {
        if (!val) {
            document.querySelector('body').classList.add('system-hidden')
        } else {
            document.querySelector('body').classList.remove('system-hidden')
        }
    }
})
        ...
        <div id="app-main">
            ...
            <div class="wrapper">
                ...
                <div class="main-container" :style="{'padding-bottom': $route.meta.paddingBottom}">
                    ...
                    <tags v-if="settingsStore.mode !== 'mobile'" />
                    <div class="main">
...
.wrapper {
    ...
    .main-container {
        ...
        .main {
            ...
            overflow: hidden;
            transition: 0.3s;
            margin: calc(var(--g-tabbar-height) + var(--g-topbar-height)) 0 0;
        }
